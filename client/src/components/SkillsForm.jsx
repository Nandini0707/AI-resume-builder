  ...
  return (
    <div className='space-y-4'>
        ...
        <div  className='flex gap-2'>
           ...
           className='flex items-center not-[gap-2 px-4 py-2 text-sm bg-blue-600 text-white rounded-lg 
        ...
        </div>
      {
        ...
        (
         <div className='text-center py-6 text-gray-500'>
            ...
            <p className="text-sm">Add your techmical and soft skills above.</p>
         </div>
        )}
        <div className='bg-blue-50 p-3 rounded-lg'>
            <p className='text-sm text-blue-800'><strong>Tip:</strong>Add 8-12 
            relevant skills.Include both technical skills(programming languages, tools) and soft skills (leadership.communication)
            </p>
        </div>
    </div>
  )
